...
PBRPipeline::PBRPipeline(unsigned int hdrTexture) {
    ...
    this->irradiancaMap = new Texture(GL_TEXTURE_CUBE_MAP,  "irradianceMap", glm::vec2(1980,1980),GL_RGB);
...
void PBRPipeline::generateIrradianceMap(Shader shader, unsigned int VAO) {
