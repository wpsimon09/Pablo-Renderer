...
public:
     ...
     */
    explicit PBRColor(glm::vec3 albedo = glm::vec3(0.4f, 0.4f, 0.4f),bool supportsIBL = false,bool supportsAreaLight = true, std::string name = "", float metallic = 0.7f , float rougness = 0.2f, float ao= 0.6f, std::string shaderNamingConvention = "_val");
private:
